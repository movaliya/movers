...
#import "AlertExtrahour.h"
#import "UIImage+ImageEffects.h"

@implementation AlertExtrahour
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    AlertExtrahour *customView = [[[NSBundle mainBundle] loadNibNamed:@"AlertExtrahour" owner:nil options:nil] lastObject];
    customView.frame = CGRectMake(0, 0, frame.size.width, frame.size.height);

    if ([customView isKindOfClass:[AlertExtrahour class]])
        return customView;
    else
        return nil;
}
